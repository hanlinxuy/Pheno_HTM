...
#	f.write("rm -rf "+options.Prefix+"_"+str(tag)+"\n")	
	...
	f.write("cp ../MadGraphControl.py . \n")
	f.write("python MadGraphControl.py -r -m "+options.mg5_exe_path+" --cmd "+os.environ['root_path']+"/"+options.Prefix+"_config/"+options.Prefix+"_"+str(tag)+".dat \n")
	f.write("cp *.xml "+os.environ['root_path']+"/"+options.Prefix+"_xml_data/"+" \n")
